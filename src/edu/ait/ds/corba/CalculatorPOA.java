...
/**
* edu_ait_ds_corba/CalculatorPOA.java .
...
public abstract class CalculatorPOA extends org.omg.PortableServer.Servant
 implements edu.ait.ds.corba.CalculatorOperations, org.omg.CORBA.portable.InvokeHandler
{
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // edu_ait_ds_corba/Calculator/add
       {
         int a = in.read_long ();
         int b = in.read_long ();
         int $result = (int)0;
       ...
       case 1:  // edu_ait_ds_corba/Calculator/subtract
       {
         int a = in.read_long ();
         int b = in.read_long ();
         int $result = (int)0;
       ...
       case 2:  // edu_ait_ds_corba/Calculator/multiply
       {
         int a = in.read_long ();
         int b = in.read_long ();
         int $result = (int)0;
       ...
       case 3:  // edu_ait_ds_corba/Calculator/divide
       {
         int a = in.read_long ();
         int b = in.read_long ();
         int $result = (int)0;
       ...
       case 4:  // edu_ait_ds_corba/Calculator/shutdown
       {
         this.shutdown ();
         out = $rh.createReply();
         break;
